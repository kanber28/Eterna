...
@section('content')
                ...
                <div class="widget-content widget-content-area">
                    <div class="w-100">
                        <div class="mt-2">
                            ...
                            @endforeach
                            <form method="POST" id="solvedForm" name="solvedForm" action="{{route('report.missionsSolved')}}" enctype="multipart/form-data">
                                @csrf
                                <input type="hidden" name="id" value="{{$mission->id}}">
                                <div class="form-group row centeredAlign">
                                    <label class="col-12 col-md-3"><span style="color: red"></span>Oluşum Nedeni</label>
                                    <div class="col-9">
                                        <input name="mission_solution_description" id="mission_solution_description" class="form-control form-control-solid" type="text"
                                               value="" >
                                    </div>
                                </div>
                                <div class="form-group row centeredAlign">
                                    <label class="col-12 col-md-3"><span style="color: red">*</span>Açıklama</label>
                                    <div class="col-9">
                                        <div class="input-group input-group-solid">
                                            <div class="input-group-prepend"></div>
                                            <input name="mission_reason_description" id="mission_reason_description" type="text" class="form-control form-control-solid"
                                                   placeholder="" >
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="widget-footer text-right" style="padding-left: 0px!important;">
                                    ...
                                    <input type="submit" class="btn btn-primary" value="Görevi Çöz"/>
                                </div>
                            </form>
                        </div>
                    </div>
    ...
    @section('js')
        ...
        <script>
            ...
            $("#solvedForm").on('submit', function(e) {
                Swal.fire({
                    icon: 'success',
                    title: 'Başarılı',
                    text: 'Görev Başarıyla Çözüldü',
