...
@section('content')
                                        ...
                                        <div class="row" style="width: 100%">
                                            <div class="col-6">
                                                <div class="col-md-12 col-sm-12">
                                                    <div class="mt-3 box-border shadow shadow" style="width: 100%;border-radius: 5px;max-height: 200px;overflow: auto">
                                    ...
                                    <div class="mt-5 form-group multi-select-area">
                                        <div class="row">
                                            <div style="display: flex; width: 100%;">
                                                <label style="margin: auto" >Çalışan Ata</label>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-sm-12 col-md-12 col-12">
                                                <label for="">Birim Kullanıcıları</label>
    ...
    <script>
        function assignRole(){
            ...
            $.ajax({
                url:'{{route('report.createMission')}}',
                type:'POST',
                data:{
                    "_token":'{{csrf_token()}}',
                    report_id:report_id,
