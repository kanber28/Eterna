                                    ...
                                    <div class="table-header" >
                                        <h4>
                                            <label style="display: flex;margin-top: 2rem; flex-direction: row;justify-content: center; align-items: center;text-align: center">
                                               Bilgi: Reddedilen görevlerde mobil personelin reddettiği görevler listelenmekte ve detayları görünmektedir.</label></h4>
                                    </div>
...
@section('js')
    <script>
        let reportTable = $('#export-dt').DataTable( {
            ...
            ajax: '{!!route('report.fetchRejectedMission')!!}',
            columns: [
                {data: 'id'},
                {data: 'reporter'},
                {data:'description'},
