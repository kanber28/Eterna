                                    ...
                                    <div id="questionArea" >
                                        <div class="row" style="justify-content: center">
                                            <div class="col-12" style="display: flex;justify-content: center;flex-direction: column;align-content: center;align-items: center">
                                                ...
                                                <input type="text" class="form-control" style="width: 50%" id="questionnaire_name">
                                            </div>
                                            <div class="col-12 mt-2" style="display: flex;justify-content: center;flex-direction: column;align-content: center;align-items: center">
                                                ...
                                                <textarea onkeyup="characterCounter(this)" name="" id="questionnaire_description" cols="30" rows="4" class="form-control" style="padding: 5px !important;width: 50% !important;" maxlength="255" ></textarea>
                                            ...
                                            <div class="col-12 mt-3" style="display: flex;justify-content: center;flex-direction: column;align-content: center;align-items: center">
                                                ...
                                                <select  class="form-control" name="" style="width: 25%" id="questionnaire_status">
                                                    ...
                                                    <option value="1" >Üyelere Açık</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div style="border: 1px solid #e5eaff; padding: 20px; margin-top:20px">
                                            <div class="row">
                                                <div class="col-md-3 col-sm-12">
                                                    <label for="question_1">Soru Tipi</label>
                                                    <select class="form-control" name="question_type_1" id="question_type_1" questionOrder="1" onchange="questionTypeSelection(this)">
                                                ...
                                                <div class="col-md-7 col-sm-12">
                                                    ...
                                                    <input id="question_title_1" type="text" class="form-control">
                                                </div>
                                                <div class="col-md-2 col-sm-12">
                                                    <label for="question_1">Zorunluluk</label>
                                                    <select class="form-control" id="question_is_necessary_1">
...
@section('js')
    <script>
        ...
        function saveQuestionnaire(){
            ...
            for (let i = 1; i <= questionCount; i++){
                ...
                if (type == 2 || type == 3){
                    ...
                    for (let j = 1; j <= optionCount; j++ ){
                        ...
                        if(tmpOptionTitle.length > 255){
                            Swal.fire({
                                'icon':'warning',
                                'title':'Seçenek Başlığı 255 Karakterden Uzun Olamaz !'
                            })
                            return false;
                        }
                        tmpOptionArr.push(tmpOptionTitle)
                    }
                ...
                if(questionTitle.length > 255){
                    Swal.fire({
                        'icon':'warning',
                        'title':'Soru Başlığı 255 Karakterden Uzun Olamaz !'
                    })
                    return false;
                }
                tmpObj = {
            ...
            $.ajax({
                url:'{{route('questionnaire.create.post')}}',
                method:'POST',
                data:{
